...
/** All Stripe traffic is proxied through the connector gateway, which holds the real secret. */
...
/**
 * Verifies the Stripe signature over the raw body. Every webhook delivery is
 * rejected unless it is signed with this environment's secret and recent.
 */
