...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Fraoula AI - Fast, focused AI chat" },
      {
        name: "description",
        content: "A minimal AI chat workspace with multiple models and prepaid credits.",
      },
      { property: "og:title", content: "Fraoula AI - Fast, focused AI chat" },
      {
